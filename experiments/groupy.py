...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, out_size=181):
        super(ResNet, self).__init__()
        self.in_planes = 23

        self.conv1 = P4ConvZ2(1, 23, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.linear = nn.Linear(out_size*4*block.expansion, num_classes)
